...
import { RoRCharacterList } from "../models/ror.models";
import { GenericSpireChallenge } from "../models/spire.models";
...
export class RoRChallenges {
  ...
  public static characters: RoRCharacterList = {
    commando: {
      intro:
        "Generic man rolls into action! Now where did he put those glasses...",
      imageName: "commando",
      challenges: [],
    },
    huntress: {
    ...
    mercenary: {
      intro:
        "While you were busy playing other games I was studying the blade.",
      imageName: "mercenary",
      challenges: [],
    },
    rex: {
      intro:
        "Wait you actually got the fuel cell here without dying? Here's a plant monster I guess.",
      imageName: "rex",
      challenges: [],
    },
    loader: {
